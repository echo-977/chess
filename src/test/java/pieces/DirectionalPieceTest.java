...
class DirectionalPieceTest {
    ...
    @BeforeEach
    public void init() {
        piece = new Knight(PieceColour.WHITE, Files.B + Ranks.ONE);
    }
    ...
    public void testDirectionalMoveSearch() {
        ...
        Move[] expectedMoves = {new Move(position, piece, Files.C + Ranks.THREE),
                new Move(position, piece, Files.D + Ranks.TWO),
                new Move(position, piece, Files.A + Ranks.THREE), null , null, null, null, null};
