...
class BishopTest {
    ...
    void testGenerateMoves() {
        ...
        Board board = FENUtils.boardFromFEN("8/8/8/8/3Bb3/8/8/8 w - - 0 1");
        Move[] piece1MovesExpected = {new Move(board, piece1, "c5"), new Move(board, piece1, "b6"),
                new Move(board, piece1, "a7"), new Move(board, piece1, "e5"),
                new Move(board, piece1, "f6"), new Move(board, piece1, "g7"),
                new Move(board, piece1, "h8"), new Move(board, piece1, "e3"),
                new Move(board, piece1, "f2"), new Move(board, piece1, "g1"),
                new Move(board, piece1, "c3"), new Move(board, piece1, "b2"),
                new Move(board, piece1, "a1")};
        Move[] piece2MovesExpected = {new Move(board, piece2, "d5"), new Move(board, piece2, "c6"),
                new Move(board, piece2, "b7"), new Move(board, piece2, "a8"),
                new Move(board, piece2, "f5"), new Move(board, piece2, "g6"),
                new Move(board, piece2, "h7"), new Move(board, piece2, "f3"),
                new Move(board, piece2, "g2"), new Move(board, piece2, "h1"),
                new Move(board, piece2, "d3"), new Move(board, piece2, "c2"),
                new Move(board, piece2, "b1")};
    ...
    void testGenerateMovesWithPieces() {
        ...
        Move[] piece1MovesExpected = {new Move(board, piece1, "e5"), new Move(board, piece1, "d6"),
                new Move(board, piece1, "c7"), new Move(board, piece1, "b8"),
                new Move(board, piece1, "g5"), move1, new Move(board, piece1, "e3"),
                new Move(board, piece1, "d2"), new Move(board, piece1, "c1"),
                null, null, null, null};
        Move[] piece1MovesActual = piece1.generateMoves(board);
        assertArrayEquals(piece1MovesExpected, piece1MovesActual);
        move1 = new Move(board, piece2, "h3");
        move1.setCapture(true);
        Move move2 = new Move(board, piece2, "c2");
        move2.setCapture(true);
        Move[] piece2MovesExpected = {new Move(board, piece2, "e6"), new Move(board, piece2, "d7"),
                new Move(board, piece2, "c8"), new Move(board, piece2, "g4"), move1,
                new Move(board, piece2, "e4"), new Move(board, piece2, "d3"),
