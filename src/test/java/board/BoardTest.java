...
class BoardTest {
    ...
    void testHandleCastle() {
        ...
        assertEquals(0b01100001_00000000_00000000_00000000_00000000_00000000_00000000_00000000L,
        ...
        assertEquals(PieceType.ROOK, piece.getType());
        assertEquals(0b10001100_00000000_00000000_00000000_00000000_00000000_00000000_00000000L,
                board.getOccupancyBitboard(ChessConstants.WHITE_BITBOARD));
        position = FENUtils.positionFromFEN("r3k2r/8/8/8/8/8/8/R3K2R b KQkq - 1 1");
        board = position.getBoard();
        ...
        assertEquals(PieceType.ROOK, piece.getType());
        assertEquals(0b00000000_00000000_00000000_00000000_00000000_00000000_00000000_01100001L,
        ...
        assertEquals(PieceType.ROOK, piece.getType());
        assertEquals(0b00000000_00000000_00000000_00000000_00000000_00000000_00000000_10001100L,
                board.getOccupancyBitboard(ChessConstants.BLACK_BITBOARD));
    }
    ...
    void testHandlePromotion() {
        ...
        assertEquals(0b00001000_00000000_00000000_00000000_00000000_00000000_00000000_00001000L,
                board.getOccupancyBitboard(ChessConstants.WHITE_BITBOARD));
        assertEquals(0b00000000_00010000_00000000_00000000_00000000_00000000_00000000_00010000L,
                board.getOccupancyBitboard(ChessConstants.BLACK_BITBOARD));
        ...
        assertEquals(0b00001000_00000000_00000000_00000000_00000000_00000000_00000000_00010000L,
                board.getOccupancyBitboard(ChessConstants.WHITE_BITBOARD));
        assertEquals(0b00000000_00010000_00000000_00000000_00000000_00000000_00000000_00000000L,
                board.getOccupancyBitboard(ChessConstants.BLACK_BITBOARD));
        position = FENUtils.positionFromFEN("4n3/3P4/8/8/8/8/4p3/3N4 w - - 0 1");
        board = position.getBoard();
        ...
        assertEquals(0b00001000_00000000_00000000_00000000_00000000_00000000_00001000_00000000L,
                board.getOccupancyBitboard(ChessConstants.WHITE_BITBOARD));
        assertEquals(0b00010000_00000000_00000000_00000000_00000000_00000000_00000000_00010000L,
                board.getOccupancyBitboard(ChessConstants.BLACK_BITBOARD));
        position = FENUtils.positionFromFEN("4n3/3P4/8/8/8/8/4p3/3N4 w - - 0 1");
        board = position.getBoard();
        ...
        assertEquals(0b00000000_00000000_00000000_00000000_00000000_00000000_00001000_00000000L,
                board.getOccupancyBitboard(ChessConstants.WHITE_BITBOARD));
        assertEquals(0b00001000_00000000_00000000_00000000_00000000_00000000_00000000_00010000L,
                board.getOccupancyBitboard(ChessConstants.BLACK_BITBOARD));
    }
