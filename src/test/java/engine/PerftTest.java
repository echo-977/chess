...
public class PerftTest {
    ...
    void  testGenerateMovesStartingPosition() {
        ...
        PerftTT transpositionTable = new PerftTT(ChessConstants.PERFT_TABLE_SIZE);
        //assertEquals(20, Perft.ThreadedPerft(position, transpositionTable, 1, false));
    ...
    void testGenerateMovesPosition3() {
        ...
        PerftTT transpositionTable = new PerftTT(ChessConstants.PERFT_TABLE_SIZE);
        //assertEquals(14, Perft.ThreadedPerft(position, transpositionTable, 1, false));
        //assertEquals(191, Perft.ThreadedPerft(position, transpositionTable, 2, false));
        //assertEquals(2812, Perft.ThreadedPerft(position, transpositionTable, 3, false));
        //assertEquals(43238, Perft.ThreadedPerft(position, transpositionTable, 4, false));
        assertEquals(674624, Perft.ThreadedPerft(position, transpositionTable, 5, false));
        //assertEquals(11030083, Perft.ThreadedPerft(position, transpositionTable, 6, false));
    }
    ...
    void testGenerateMovesPosition4() {
        ...
        PerftTT transpositionTable = new PerftTT(ChessConstants.PERFT_TABLE_SIZE);
        //assertEquals(6, Perft.ThreadedPerft(position, transpositionTable, 1, false));
